...
class RCF(nn.Module):
    def __init__(self, rate=4):
        ...
        self.msblock5 = MSBlock(512, rate)
        ...
        self.conv2_1_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv2_2_down = nn.Conv2d(32, 21, 1, padding=0)

        self.conv3_1_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv3_2_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv3_3_down = nn.Conv2d(32, 21, 1, padding=0)

        self.conv4_1_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv4_2_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv4_3_down = nn.Conv2d(32, 21, 1, padding=0)
        
        self.conv5_1_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv5_2_down = nn.Conv2d(32, 21, 1, padding=0)
        self.conv5_3_down = nn.Conv2d(32, 21, 1, padding=0)
    ...
    def forward(self, x):
        ...
        conv1_1_down = self.conv1_1_down(self.msblock1(conv1_1))
        conv1_2_down = self.conv1_2_down(self.msblock1(conv1_2))
        conv2_1_down = self.conv2_1_down(self.msblock2(conv2_1))
        conv2_2_down = self.conv2_2_down(self.msblock2(conv2_2))
        conv3_1_down = self.conv3_1_down(self.msblock3(conv3_1))
        conv3_2_down = self.conv3_2_down(self.msblock3(conv3_2))
        conv3_3_down = self.conv3_3_down(self.msblock3(conv3_3))
        conv4_1_down = self.conv4_1_down(self.msblock4(conv4_1))
        conv4_2_down = self.conv4_2_down(self.msblock4(conv4_2))
        conv4_3_down = self.conv4_3_down(self.msblock4(conv4_3))
        conv5_1_down = self.conv5_1_down(self.msblock5(conv5_1))
        conv5_2_down = self.conv5_2_down(self.msblock5(conv5_2))
        conv5_3_down = self.conv5_3_down(self.msblock5(conv5_3))
...
def upsample(input, stride, num_channels=1):
    ...
    kernel = make_bilinear_weights(kernel_size, num_channels)
    if torch.cuda.is_available():
